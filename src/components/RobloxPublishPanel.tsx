    ...
    <div className="flex flex-col h-full bg-slate-950 border border-slate-800 rounded-lg overflow-y-auto p-6 space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-5 space-y-4">
        ...
        <div className="p-3.5 rounded-md bg-slate-950 border border-slate-800/90 text-xs space-y-2">
          ...
          <div className="text-[11px] text-slate-400 bg-slate-900/50 p-2 rounded border border-slate-800/60 space-y-1">
            <p className="font-semibold text-cyan-300">💡 Roblox Live Update Note:</p>
            <p>Open Cloud publishes a new version to your Place Version History. If your live game client does not show updates immediately, check the <strong className="text-slate-200">Roblox Creator Dashboard → Creator Hub → Version History</strong> to ensure the published version is active, or use <strong>Export Project (ZIP)</strong> to open the <code className="text-cyan-300">.rbxlx</code> in Roblox Studio and publish.</p>
          </div>
